#ifndef MODULES_M6_INCLUDE_HVR_HW6_UTILS_H_
#define MODULES_M6_INCLUDE_HVR_HW6_UTILS_H_
...
template <typename T>
void checkResultsEps(const T* const ref,
                     const T* const gpu,
                     size_t numElem,
                     double eps1,
                     double eps2)
...
template <typename T>
void checkResultsAutodesk(const T* const ref,
                          const T* const gpu,
                          size_t numElem,
                          double variance,
                          size_t tolerance)
...
#endif  // MODULES_M6_INCLUDE_HVR_HW6_UTILS_H_
