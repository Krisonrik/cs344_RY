...
#include <iostream>
#include <string>
#include "hvr/HW4/timer.h"
#include "hvr/HW4/utils.h"

#include "hvr/HW4/compare.h"
...
int main(int argc, char **argv)
{
  ...
  switch (argc)
  {
    ...
    case 4:
      ...
      break;
    default:
      std::cerr << "Usage: ./HW4 input_file template_file [output_filename]"
                << std::endl;
      exit(1);
  }
  // load the image and give us our input and output pointers
  preProcess(&inputVals,
             &inputPos,
             &outputVals,
             &outputPos,
             numElems,
  ...
  reference_calculation(
      h_inputVals, h_inputPos, h_outputVals, h_outputPos, numElems);
