...
#include "hvr/HW2/timer.h"
#include "hvr/HW2/utils.h"

#include "hvr/HW2/compare.h"
#include "hvr/HW2/reference_calc.h"

// include the definitions of the above functions for this homework
#include "hvr/HW2/HW2.h"
...
int main(int argc, char **argv)
{
  ...
  your_gaussian_blur(h_inputImageRGBA,
                     d_inputImageRGBA,
                     d_outputImageRGBA,
                     numRows(),
                     numCols(),
  ...
  checkCudaErrors(cudaMemcpy(h_outputImageRGBA,
                             d_outputImageRGBA__,
  ...
  referenceCalculation(h_inputImageRGBA,
                       h_outputImageRGBA,
                       numRows(),
                       numCols(),
                       h_filter,
