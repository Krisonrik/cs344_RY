...
#include <iostream>
#include <string>
#include "hvr/HW1/HW1.h"
#include "hvr/HW1/compare.h"
#include "hvr/HW1/reference_calc.h"
#include "hvr/HW1/timer.h"
...
int main(int argc, char **argv)
{
  ...
  preProcess(
      &h_rgbaImage, &h_greyImage, &d_rgbaImage, &d_greyImage, input_file);

  GpuTimer timer;
  timer.Start();
  // call the students' code
  your_rgba_to_greyscale(
      h_rgbaImage, d_rgbaImage, d_greyImage, numRows(), numCols());
  timer.Stop();
